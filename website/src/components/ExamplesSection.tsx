...
const ExamplesSection = () => {
  return (
    <section id="examples" className="py-24 px-4" data-aos="fade-in">
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          {examplesData.map((example, index) => (
            <div key={index} data-aos="fade-up" data-aos-delay={index * 100}>
              <Card className="h-full border-border/50 group bg-card/50 backdrop-blur-sm shadow-sm hover:shadow-lg transition-all duration-300">
                <CardHeader>
                ...
                <CardContent>
                  <div className="space-y-4">
                    {example.examples.map((text, idx) => (
                      <div key={idx} className="p-3 rounded-md border-l-4 border-accent/40 bg-accent/5 hover:border-accent/60 transition-colors">
                        <p className="text-sm text-foreground/80 italic font-medium">"{text}"</p>
                      </div>
                    ))}
                  </div>
                </CardContent>
        ...
        <div className="text-center mt-16" data-aos="fade-up" data-aos-delay="200">
          <Card className="max-w-2xl mx-auto bg-card/50 backdrop-blur-sm shadow-sm p-2">
